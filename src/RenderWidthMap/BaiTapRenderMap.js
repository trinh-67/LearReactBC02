...
export default class BaiTapRenderMap extends Component {
        ...
        const arrTagFilm = this.dataFilm.map((phim, index) => {
            return <div key={index} className="col-4">
              <div className="card text-white bg-dark">
                <div style={{backgroundImage: `url('${this.hinhAnh}'), url('https://picsum.photos/150/450')`,
                backgroundPosition: 'center',backgroundSize: 'cover'}}>
                    <img style={{opacity:1}} width="150" height="450" className="card-img-top" src={phim.hinhAnh} alt={phim.hinhAnh} />
                </div>
    ...
    //viết hàm hiển thị danh sách phim dưới dạng div card boostrap
    render() {
        return (
