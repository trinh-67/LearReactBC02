    ...
    dataFilm = [
        {
            ...
            "hinhAnh": "https://movie0706.cybersoft.edu.vn/hinhanh/ted2_gp08.png1",
    ...
    renderFilm = () => {
        const arrTagFilm = this.dataFilm.map((phim, index) => {
            return <div key={index} className="col-4 mt-2">
                <div className="card text-white bg-dark border-none">
                    <div style={{backgroundImage:`url('${phim.hinhAnh}'), url('https://picsum.photos/150/450')`,backgroundPosition:'center',backgroundSize:'cover'}}>
                        <img style={{opacity:0}} width="150" height="450" className="card-img-top" src={phim.hinhAnh} alt={phim.hinhAnh}  />
                    </div>
                    <div className="card-body">
                        <h4 className="card-title" style={{ height: 50 }}>
                            {phim.tenPhim.length > 50 ? <p>{phim.tenPhim.sub(0, 100)} ...</p> : <p>
                                {phim.tenPhim}
                            </p>}
                        </h4>
                        <div style={{ height: 80 }} className="card-text">{phim.moTa.length > 100 ? <p>{phim.moTa.substr(0, 100)} ...</p> : <p>{phim.moTa}</p>}
                        </div>
                    </div>
                </div>
            </div>
